...
class Logo extends Component {
    render() {
        return(<div className="Logo__img">
        <svg width="1.5em" height="1.5em" viewBox="0 0 16 16" className="bi bi-clipboard-data" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
